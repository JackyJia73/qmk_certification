...
extern uint8_t hid_ref_descs[BLE_CFG_HIDS_INPUT_REPORT_NB + BLE_CFG_HIDS_OUTPUT_REPORT_NB];
                            ...
                            uint8_t *pPayload)
{
  ...
  switch(UUID)
  {
    ...
    case REPORT_REFERENCE_DESCRIPTOR_UUID:
    	return_value = aci_gatt_update_char_value(HIDS_Context[service_instance].HidSvcHdle,
    	                                                  HIDS_Context[service_instance].HidReportReferenceDescHdle[Report_Index],
    	                                                  0, /* charValOffset */
    	                                                  report_size,
    	                                                  pPayload);
    	break;
