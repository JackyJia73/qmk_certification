...
/*
 * Setup for a Generic GD32L235R board.
 */

/*
 * Board identifier.
 */
#define BOARD_GD_GD32L235R_EVAL
#define BOARD_NAME              "GD GD32L235R-EVAL"
...
/*
 * MCU type, supported types are defined in .\os\hal\ports\GD\GD32L23x\hal_lld.h.
 */
#define GD32L235RB
...
#define CLK_GPIO_LED1              RCU_AHBEN_PAEN
#define CLK_GPIO_LED2              RCU_AHBEN_PBEN

#define PIN_WAKEUP                 0
#define PIN_TAMPER                 13
#define PORT_WAKEUP                GPIOA
#define PORT_TAMPER                GPIOC
#define CLK_GPIO_WAKEUP            RCU_AHBEN_PAEN
#define CLK_GPIO_TAMPER            RCU_AHBEN_PCEN
#define LINE_WAKEUP                PAL_LINE(PORT_WAKEUP, PIN_WAKEUP)
#define LINE_TAMPER                PAL_LINE(PORT_TAMPER, PIN_TAMPER)
 ...
 * Please refer to the GD32 Reference Manual for details.
 */
...
#define VAL_GPIOFCRH            0x44344444      /* PF15...PF8 */
